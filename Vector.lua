...
Vector.meta = {
    ...
    __pow = function (self, value)
        if type(value) == "number" then return Vector(self.x^value, self.y^value) end
...
function Vector:set(direction, y)
    if type(direction) == "string" then
        if direction == "up" then self.x, self.y =  0, -1
        elseif direction == "right" then self.x, self.y =  1, 0
        elseif direction == "down" then self.x, self.y =  0, 1
        elseif direction == "left" then self.x, self.y =  -1, 0 end
